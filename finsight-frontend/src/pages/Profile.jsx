...
export default function Profile() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {/* Edit name */}
      <form onSubmit={saveName} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm shadow-gray-200/50 dark:shadow-none p-6 space-y-4">
      ...
      {/* Change password */}
      <form onSubmit={savePassword} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm shadow-gray-200/50 dark:shadow-none p-6 space-y-4">
      ...
      {/* Danger zone */}
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm shadow-gray-200/50 dark:shadow-none p-6 flex items-center justify-between">
        <div>
          <h2 className="font-bold">Sign out</h2>
          <p className="text-sm text-gray-400">Log out of FinSight on this device</p>
        </div>
        <button onClick={logout}
          className="border border-red-200 dark:border-red-900 text-red-600 dark:text-red-400 px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-red-50 dark:hover:bg-red-950/50 cursor-pointer">
          Log out
        </button>
      </div>
    </div>
